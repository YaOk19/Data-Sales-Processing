...
def kelompokan(customer_name):
    ...
    # lena
    kelompok_d = [
        "RS HERMINA ACEH", "RS HERMINA LAMPUNG", "RS HERMINA MEDAN", "RS HERMINA OPI JAKABARING", "RS HERMINA PADANG", "RS HERMINA PALEMBANG", "RS HERMINA PEKANBARU", "KOKARMINA ACEH"
    ]
    # gita
    kelompok_e = [
